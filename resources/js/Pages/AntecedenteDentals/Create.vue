...
const { limpiarAntecedenteDental } = useAntecedenteDentals();
...
<template>
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
            <Link :href="route('antecedente_dentals.index')"
                >Antecedente Dental</Link
            >
        </li>
    ...
    <!-- END breadcrumb -->
    <!-- BEGIN page-header -->
    <h1 class="page-header">Antecedente Dental > nuevo</h1>
    <!-- END page-header -->
