...
const generarReporte = () => {
    ...
    axios
        .get(route("reportes.r_pacientes_doctor"), { params: form.value })
        .then((response) => {
            // Create the chart
...
<template>
    <Head title="Reporte Cantidad Pacientes por Doctor"></Head>
    <!-- BEGIN breadcrumb -->
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="javascript:;">Inicio</a></li>
        <li class="breadcrumb-item active">Reportes > Cantidad Pacientes por Doctor</li>
    </ol>
    <!-- END breadcrumb -->
    <!-- BEGIN page-header -->
    <h1 class="page-header">Reportes > Cantidad Pacientes por Doctor</h1>
    <!-- END page-header -->
    <div class="row">
